...
namespace func_rocket
{
	public class GameForm : Form
	{
		...
		private void DrawTo(Graphics g)
		{
			...
			// var penBlack = new Pen(Color.Black, 3);
			// var penGreen = new Pen(Color.Green, 3);
			// var penBlue = new Pen(Color.DodgerBlue, 3);
			// var strechRatio = 6;
			...
			// g.DrawLine(penBlack, LogContainer.RocketPositionPointF,
			// 	LogContainer.GetPoint(LogContainer.rocketSpeed * strechRatio + LogContainer.rocketPosition));
			// g.DrawLine(penRed, LogContainer.RocketPositionPointF,
			// 	LogContainer.GetPoint(LogContainer.directToTarget + LogContainer.rocketPosition));
			// g.DrawLine(penGreen, LogContainer.RocketPositionPointF,
			// 	LogContainer.GetPoint(LogContainer.reflectionRocketSpeedFromDirectToTarget * strechRatio + LogContainer.rocketPosition));
			// g.DrawLine(penBlue, LogContainer.RocketPositionPointF,
			// 	LogContainer.GetPoint(LogContainer.rocketPosition + 20 * LogContainer.noseDirection));
